...
<head>
  <title>Supervisor Panel - Global FYP</title>
  <meta charset="utf-8" />
        ...
        <div class="row">
           <div class="col-sm-3">
            <div class="info-nav">
              ...
              <div class="info-nav-dtl"><a href="tel:#">021-36440111</a></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="info-nav">
              <div class="info-nav-heading">Email Address:</div>
              <div class="info-nav-dtl"><a href="mailto:#">info@globalfyp.com</a></div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="info-nav">
              <div class="info-nav-heading">Contact</div>
              <div class="info-nav-dtl">Hamdard University</div>
            </div>
          </div>
          <div class="col-sm-3">
