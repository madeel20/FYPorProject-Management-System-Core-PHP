				      ...
				      <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><h4><i class="glyphicon glyphicon-pencil"></i> Create Message</h4></div>
                            </div>
								...
								<form method="post" id="send_message">
										<div class="control-group">
                                          ...
                                          <div class="controls">
											...
											<?php
											$query = mysqli_query($con, "select * from tbl_supervisor where approve=1 and id !=".$_SESSION['id']." order by fname ASC ");
