...
if ($result->num_rows > 0) {
	...
	$imgsrc = $target_dir.$uid.$username.'.'.$imageFileType;
		if (move_uploaded_file($_FILES["img"]["tmp_name"], $imgsrc)) {
			...
			if($usertype == 'Student'){
			$sql = "INSERT INTO `tbl_student`(`fname`, `lname`, `university`, `country`, `username`, `pass`,`img`,active,qualifications,email,gender) VALUES ('".$fname."','".$lname."','".$university."','".$country."','".$username."','".$pass."','..\\\\".$imgsrc."',1,'".$qual."','".$email."','".$gender."')";
			$con->query($sql);	
		...
		$sql = "INSERT INTO `tbl_supervisor`(`fname`, `lname`, `university`, `country`, `username`, `pass`,`img`,active,qualifications,email,gender,areaofinterest) VALUES ('".$fname."','".$lname."','".$university."','".$country."','".$username."','".$pass."','..\\\\".$imgsrc."',1,'".$qual."','".$email."','".$gender."','".$_POST['intarea']."')";
		$con->query($sql);	
		header('Location: approve.php');
		exit();
...
<div class="col-sm-6">
 <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <input type="text" required class="form-control"  name="university" placeholder="Enter Your Universty " value="<?php if(isset($kfname)) echo $kuniversity;?>"/>
              </div>
              <div class="form-group">
