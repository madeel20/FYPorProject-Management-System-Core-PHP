...
<!--  page banner -->
 ...
 <div class="row">
   ...
   <h2 class="page-banner-heading  text-center">Admin Panel:  </h2><p>View Supervisor:</p>
   </div>
   <div class="col-sm-2"></div>
</div>
  </section> 
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
     ...
     echo '<tr> <th colspan=1>First Name: </th>';
        ...
        echo '<tr> <th colspan=1> Area Of Interest: </th>';
        echo '<td colspan=2>'.$row['areaofinterest'].'</td></tr>';
