...
<!--  page banner -->
  <section id="page-banner" class="page-banner-main-block" style="background-image: url('..\images/bg/page-banner.jpg')">
  	<div class="row">
  <div class="col-sm-2 text-center" style="float:left;"> <a href="<?php if(isset($_POST['fromprj'])) echo 'projects.php'; else echo 'approvalreqprj.php';?>"><button type="submit" class="btn btn-default">Back</button></a></div>
 ...
 <div class="row">
   ...
   <h2 class="page-banner-heading  text-center">Admin Panel:  </h2><p>View Project:</p>
   </div>
   <div class="col-sm-2"></div>
</div>
  </section> 
...
<div class="col-sm-12">
  ...
  $sql ="SELECT * FROM `tbl_projects` inner join tbl_student ON tbl_projects.studentid=tbl_student.id where pid=".$_POST['prjid'];
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo '<td colspan=2 >'.$row['university'].'</td></tr>';
        ...
        echo '<td colspan=2>'.$row['type'].'</td></tr>';
         ...
         echo '<td colspan=2  >No Project file</td></tr>';
