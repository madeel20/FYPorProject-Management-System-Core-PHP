 ...
 <div class="form-group">
  ...
  <label>Project Name: </label>
             ...
             <div class="form-group">
              ...
              <input type="radio" id="Individual" value="Individual" name="members" /> Individual
              <input type="radio" id="Group"   value="Group Base" name="members" /> Group Base
              ...
              <tr><td class="text-center" colspan=1> 2:</td><td colspan=7> <input type="text" class="form-control"  value="<?php if(isset($mem[0])) echo  $mem[0];?>"  name="mem2" placeholder="Enter Member ..." /></td></tr>

              <tr><td class="text-center" colspan=1> 3:</td><td colspan=7> <input type="text" class="form-control"  value="<?php if(isset($mem[1])) echo  $mem[1];?>"  name="mem3" placeholder="Enter Member ..."/></td></tr>

              <tr><td class="text-center" colspan=1> 4:</td><td colspan=7> <input type="text" class="form-control"  value="<?php if(isset($mem[2])) echo  $mem[2];?>"  name="mem4" placeholder="Enter Member ..."/></td></tr>
            </table>
              </div>
                </div>
...
$(document).ready(function(){
    if('<?php echo $members;?>'== 'Group Base'){
